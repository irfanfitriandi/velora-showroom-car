...
const Footer = () => {
  return (
    <footer className="border-b-vl-primary border-b-[12px] bg-black px-4 py-[80px] text-white">
      <div className="container mx-auto flex flex-col justify-between gap-8 px-5 md:flex-row">
        {/* Brand */}
        ...
        <div className="flex flex-col gap-8 md:flex-row md:gap-6 lg:gap-14">
          {/* Menus */}
          <div className="">
            <h3 className="text-vl-neutral-5 text-sm text-nowrap">{FOOTER_CONTENT.menus.title}</h3>
            <ul className="mt-1 flex flex-col gap-1 md:mt-6">
